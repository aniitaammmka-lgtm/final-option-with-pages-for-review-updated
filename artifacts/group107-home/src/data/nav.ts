...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    url: "/product-lobby",
    panels: [
      { heading: "Our Products", links: [{ label: "Accessible Docs", url: "/product-lobby#accessible-docs" }, { label: "Global Docs", url: "/product-lobby#global-docs" }, { label: "Summa", url: "/summa" }, { label: "Levent", url: "/product-lobby#levent" }] },
    ],
