...
export const navItems: NavItem[] = [
  {
    ...
    panels: [
      ...
      { heading: "Development Services", url: "/development-services", links: [{ label: "Web Development", url: "/web-development" }, { label: "Software Development", url: "/software-development" }, { label: "Mobile Development", url: "/mobile-development" }, { label: "Product Discovery", url: "/development-services#discovery" }] },
