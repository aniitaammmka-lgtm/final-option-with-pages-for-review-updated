...
export const navItems: NavItem[] = [
  {
    ...
    panels: [
      ...
      { heading: "Development Services", url: "/development-services", links: [{ label: "Web Development", url: "/development-services#web" }, { label: "Software Development", url: "/development-services#software" }, { label: "Mobile Development", url: "/development-services#mobile" }, { label: "Product Discovery", url: "/development-services#discovery" }] },
